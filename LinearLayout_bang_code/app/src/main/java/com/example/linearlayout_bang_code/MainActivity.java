package com.example.linearlayout_bang_code;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void createNameContainer() {
        ...
        llNameContainer.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT));
    ...
    private void createParentContainer() {
        ...
        llParentContainer.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT));
